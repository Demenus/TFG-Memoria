...
\robotto is a 3D game engine for Android platform. It aims to be simple of use tool, extraordinarily lightweight yet very powerful.\\
This proyect comes from the absence of a 3D engine easy to integrate into a Android project and with a free software license.\\
Moreover \robotto has been developed with all of Android hardware limitations in mind, so this proyect has been optimized from the scratch.
Besides additional tools has been developed alongside \robotto. The called \studio provides a functional environment designed to speed up and complete the software development experience.\\
In conclusion, both \robotto and \studio gives a trully functional tool for creating 3D graphics applications.
...
\dedicatory{A mis padres, familia y amigos} % Dedication text
...
\input{Appendices/MRRFormatFile}
